...
function convertDateToTimezone(date, timezone) {
    var index = getTimezoneIndex(timezone);
    //var localtztime = date; //new Date(date.getUTCFullYear(), date.getUTCMonth(), date.getUTCDate(), date.getUTCHours(), date.getUTCMinutes(), date.getUTCSeconds());
    console.log(date);
    date.setHours(date.getHours() + date.getTimezoneOffset()/60);
    console.log(date);
    date.setHours(date.getHours() + array[index].offset);
    console.log(date, array[index].offset, date.getTimezoneOffset()/60);
    console.log();
    return date
}
